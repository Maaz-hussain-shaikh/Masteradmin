...
const Addonmodal = () => {
    ...
    const handleSubmit = async (e: any) => {
        ...
        try {
            ...
            const payload = {
                itinerary_id: slug,
                itinerary_addOns_title: title,
                itinerary_addOns_description: cleanHTML,
                itinerary_addOns_amount: price,
                itinerary_addOns_createby: Editorname
            };

            const response = await axios.post(
                API_URLS.itinerary.addItineraryAddOn,
                payload,
                {
                    headers: {
        ...
        <div className="relative w-full p-4 overflow-y-auto bg-white no-scrollbar rounded-3xl dark:bg-gray-900 lg:p-11">
            ...
            <form className="flex flex-col" onSubmit={handleSubmit}>
                <div className="px-2 overflow-y-auto custom-scrollbar">
                    <div className="mb-4">
                        <Label>Heading of Activite</Label>
                        <Input
                            type="text"
                            placeholder="Paraglaiding in kullu"
                            value={title}
