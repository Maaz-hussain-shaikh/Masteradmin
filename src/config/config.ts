...
export const API_URLS = {
  ...
  itinerary: {
    create: `${BASE_URL}/TravelTech/itinerary/add`,
    additineraryimg: `${BASE_URL}/TravelTech/itinerary/addItineraryImage`,
    ...
    Editfaq: (id: any, num: number) => `${BASE_URL}/TravelTech/itinerary/updateItineraryFaq/${id}/${num}`,
    ...
    Deleteimage: (id: any, num: number) => `${BASE_URL}/TravelTech/itinerary/deleteItineraryImage/${id}/${num}`,
    Updateimage: (id: any, num: number) => `${BASE_URL}/TravelTech/itinerary/updateItineraryImage/${id}/${num}`,
    fetchBatchs: (id: any) => `${BASE_URL}/TravelTech/tripbatches/byitinerary/${id}`,
