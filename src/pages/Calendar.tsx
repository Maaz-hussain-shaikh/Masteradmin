          ...
          <div className="flex flex-col px-2 overflow-y-auto custom-scrollbar">
            ...
            <div className="flex items-center gap-3 mt-6 modal-footer sm:justify-end">
              ...
              <button
                ...
                type="button"
                className="btn btn-success btn-update-event flex w-full justify-center rounded-lg bg-orange-600 px-4 py-2.5 text-sm font-medium text-white hover:bg-brand-600 sm:w-auto"
              >
